  ...
  try {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
          ...
          // apiKey: "AIzaSyAdw02Z2LNbBAe-Evr6Rc67q118JLrSnoo",
          // authDomain: "sessiontesting-db446.firebaseapp.com",
          // projectId: "sessiontesting-db446",
          // storageBucket: "sessiontesting-db446.firebasestorage.app",
          // messagingSenderId: "392516856859",
          // appId: "1:392516856859:web:17d403ea4d8fc60536dcbe"
      ),
    );
    runApp(MyApp());
  } catch (e) {
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: AuthWrapper(), // This will check session status at launch
    );
  }
}
